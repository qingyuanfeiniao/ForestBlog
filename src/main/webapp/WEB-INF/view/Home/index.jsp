                ...
                <c:forEach items="${articleListVoList}" var="a">
                    ...
                    <article  class="post type-post">
                        ...
                        <figure class="thumbnail">
                            ...
                            <span class="cat">
                                <a href="/category/${a.categoryCustomList[fn:length(a.categoryCustomList)-1].categoryId}">
                                        ${a.categoryCustomList[fn:length(a.categoryCustomList)-1].categoryName}
                                     <!--    a.categoryCustomList.size() -->
                                </a>
                            </span>
                        </figure>
